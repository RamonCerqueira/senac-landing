    ...
    return (
      <section className="bg-gray-100 py-20 px-6" id="diferenciais">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-blue-700 mb-12">Por que escolher o Senac RN?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {itens.map((item, i) => (
              <div key={i} className="bg-white rounded-xl shadow p-6">
                <h3 className="text-xl font-semibold text-orange-700 mb-2">{item.titulo}</h3>
